        ...
        <div>
            <div className="navbar">
                <Link to="/" className="p-0 mb-1">
                    <div className="ml-3 mb-2 "><FontAwesomeIcon className="iconHeader" icon={faHome} size="lg"/></div>
                </Link>
                <div className="dropdown">
                    <FontAwesomeIcon className="mb-2 iconHeader" icon={faList} size="sm"/>
                    <button className="dropbtn">
                        <Link to="/AllCategoriesPage" className="p-0 text-white">دسته‌بندی محصولات</Link>
                    </button>
                                    ...
                                    ? categories[categoryId].map(item => (
                                        ...
                                        <ListGroup key={item.id}>
                                            <ListGroupItem
                                                className="listItem"
                                                tag="a"
                                                href={`/CategoryProductsPage/${item.id}`}>{item.name}</ListGroupItem>
                                        </ListGroup>
                                    ))
                                    : <div></div>}
